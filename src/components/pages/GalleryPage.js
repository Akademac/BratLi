...
const img1 = window.location.origin + "/BratLi/assets/Images/Gallery/gallery_img_1.webp";
const img2 = window.location.origin + "/BratLi/assets/Images/Gallery/gallery_img_2.webp";
const img3 = window.location.origin + "/BratLi/assets/Images/Gallery/gallery_img_3.webp";
const img4 = window.location.origin + "/BratLi/assets/Images/Gallery/gallery_img_4.webp";
const img5 = window.location.origin + "/BratLi/assets/Images/Gallery/gallery_img_5.webp";
const img6 = window.location.origin + "/BratLi/assets/Images/Gallery/gallery_img_6.webp";
const img7 = window.location.origin + "/BratLi/assets/Images/Gallery/gallery_img_7.webp";
const img8 = window.location.origin + "/BratLi/assets/Images/Gallery/gallery_img_8.webp";
const img9 = window.location.origin + "/BratLi/assets/Images/Gallery/gallery_img_9.webp";
const img10 = window.location.origin + "/BratLi/assets/Images/Gallery/gallery_img_10.webp";
    ...
    <div className="gallery__container">
      <div className='over_div'>
        ...
        <span className='go_back' >
          <i className="fas fa-caret-left" onClick={() => { window.open('/BratLi', '_self') }} style={{cursor: 'pointer', zIndex: '2000'}}></i>
        </span>
      </div>
